...
import CharlasTalleresImg from "../imgs/charlas_talleres_new.png";
import GestionEjecucionImg from "../imgs/gestion_ejecucion_proyectos_new.png";
...
const ServiceDetails = () => {
  ...
  const psicoterapiaTypes = [
    {
      ...
      description:
        "Ofrecemos un acompañamiento cálido y confidencial\
      ...
      icons: [
        { icon: FaClock, tooltip: "Sesiones de 45-60 minutos" },
        {
          ...
          tooltip:
            "¿Puedo sacar cita para un familiar?\n\
        ...
        },
        {
          icon: FaCalendarAlt,
          tooltip:
            "Contacto: +591 72564060 | Horarios: Lun-Vie 8AM-10PM y Sáb 9AM-2PM",
        },
      ],
    },
    {
      ...
      description:
        "Ofrecemos un acompañamiento discreto y humano enfocado en la\
    ...
    },
    {
      ...
      description:
        "Ofrecemos un acompañamiento cálido y respetuoso dirigido al sistema\
      ...
      icons: [
        { icon: FaClock, tooltip: "Sesiones de 45-60 minutos" },
        {
          icon: FaQuestionCircle,
          tooltip:
            "¿Cuántos miembros de la familia pueden ir?\n\
    ...
    },
    {
      ...
      description:
        "Ofrecemos un acompañamiento humano y respetuoso dirigido a\
      ...
      icons: [
        ...
        { icon: FaPeopleArrows, tooltip: "Para edades de 4 a 17 años" },
        {
          icon: FaQuestionCircle,
          tooltip:
            "¿Quién viene a la primera sesión?\n\
    ...
    {
      title: "Co-terapia familiar: orientación para padres e hijos",
      description:
        "Ofrecemos un espacio de acompañamiento familiar cálido, respetuoso y confidencial, dirigido\
        a padres e hijos que buscan mejorar su comunicación, fortalecer sus vínculos y afrontar\
        conjuntamente las dificultades familiares.\nA diferencia de una terapia convencional,\
        la co-terapia cuenta con dos terapeutas que trabajan de manera coordinada, permitiendo abordar\
        simultáneamente diferentes perspectivas y dinámicas familiares. Esto favorece un proceso más\
        eficiente, facilita la intervención sobre distintas necesidades y puede contribuir a reducir la\
  ...
  const psicoterapiaLineaIcons = [
    ...
    {
      icon: FaQuestionCircle,
      tooltip: "¿Debo encender cámara?\nDepende de la comodidad del paciente",
    },
    {
      icon: FaCamera,
      tooltip: "Plataformas: Zoom, Meet, FaceTime, WhatsApp, Discord, Gather",
    },
    {
      icon: FaCircleDollarToSlot,
      tooltip: "Métodos de pago: Transferencia, QR, Binance, PayPal, Takenos",
    },
    {
      icon: FaCalendarAlt,
      tooltip:
  ...
  const dueloIcons = [
    ...
    { icon: FaPaw, tooltip: "Se trabajan duelos por mascotas" },
    {
      icon: FaQuestionCircle,
      tooltip:
        "¿Atiende a personas de la tercera edad?\n\
    Si\n\
    ¿Atiende a niños?\n\
    Si",
    },
  ...
  const neuropsicologiaIcons = [
    ...
    { icon: FaUsers, tooltip: "Se trabaja de forma individual y por parejas" },
    {
      icon: FaQuestionCircle,
      tooltip:
        "¿El programa es solo para atletas?\n\
  ...
  const vitaeTypes = [
    {
      ...
      description:
        "En VITAE acompañamos a los estudiantes en uno de los pasos más importantes\
      ...
      icons: [
        ...
        {
          icon: FaSchool,
          tooltip: "Se hacen descuentos por grupos de personas o por colegios",
        },
        {
          icon: FaQuestionCircle,
          tooltip:
            "¿Solo puedo tomar las pruebas?\n\
    ...
    },
    {
      ...
      description:
        "Ofrecemos charlas y talleres gratuitos para estudiantes de quinto y sexto\
  ...
  const juventudIcons = [
    ...
    { icon: FaPeopleArrows, tooltip: "Para personas de 16 años para arriba" },
    {
      ...
      tooltip: "Se trabaja en consultorio y ambientes externos",
    },
    {
      icon: FaQuestionCircle,
      tooltip:
        "¿Quiénes deben estar presentes en la primera sesión?\n\
    Padres o tutores\n\
  ...
  const charlasTalleresTypes = [
    {
      ...
      description:
        "Esta charla está dirigida a colegios y a padres de familia con hijos entre los 5 y 12 años de\
      edad.\n\
      ...
      finalDescription:
        " El propósito es ofrecer una mirada integral del niño, entendiendo que atraviesa distintas\
    ...
    },
    {
      ...
      description:
        "Este taller está dirigido al personal docente de colegios que cuentan con estudiantes dentro\
      ...
      finalDescription:
        "El taller brinda al profesorado una comprensión clara de la base teórica del espectro autista,\
    ...
    },
    {
      ...
      description:
        "Esta charla está dirigida a padres y atletas de distintas disciplinas y tiene como objetivo\
      ...
      finalDescription:
        "Durante la charla, los participantes obtendrán una visión integral que resalta la importancia\
    ...
    },
    {
      ...
      finalDescription:
        "En esta charla se destaca la autonomía como una habilidad esencial para el crecimiento de\
  ...
  return (
    <div className="service-details">
        ...
        <div className="container">
          ...
          <div className="service-content">
            <div className="service-image">
              <img src={PsicoterapiaImg} alt="Psicoterapia" />
            </div>
            <div className="service-info">
              <p className="service-description">
                Ofrecemos diferentes modalidades de psicoterapia adaptadas a las
                necesidades específicas de cada paciente, desde atención
                individual hasta terapia familiar y de pareja.
              </p>
                        ...
                        <div className="therapy-icons">
                          {type.icons.map((iconData, iconIndex) => (
                            <div
                              ...
                              onMouseEnter={() =>
                                setHoveredIcon(`${index}-${iconIndex}`)
                              }
      ...
      <section
        className="service-section terapia-familiar"
        id="psicoterapia-linea"
      >
        <div className="container">
          <div className="service-header">
          ...
          <div className="service-content reverse">
            <div className="service-info">
              <p className="service-description">
                Ofrecemos un acompañamiento profesional y humano a distancia,
                dirigido a personas desde la adolescencia hasta la tercera edad.
                Este servicio brinda orientación y apoyo en la vida cotidiana,
                abordando problemáticas culturales, sociales, económicas y
                emocionales, así como el seguimiento de tratamientos previamente
                establecidos y diagnosticados. Resulta especialmente útil para
                quienes atraviesan procesos migratorios, experiencias de la vida
                foránea o cambios educativos y laborales que requieren toma de
                decisiones importantes en la vida adulta. También se acompaña a
                parejas que construyen vínculos interculturales, ayudándolas a
                enfrentar los desafíos que surgen al integrar tradiciones,
                valores y expectativas de distintos países. La psicoterapia en
                línea facilita el acceso desde cualquier lugar del mundo,
                permitiendo recibir ayuda oportuna, trabajar en la prevención y
                favorecer la detección temprana de dificultades, siempre en un
                espacio seguro, cercano y confidencial.
              </p>
              <div className="therapy-icons">
                {psicoterapiaLineaIcons.map((iconData, iconIndex) => (
                  ...
                  >
                    ...
                    {hoveredIcon === `online-${iconIndex}` && (
                      <div className="icon-tooltip">{iconData.tooltip}</div>
                    )}
                  </div>
                ))}
              </div>
            ...
            <div className="service-image">
              <img src={PsicoterapiaLineaImg} alt="Psicoterapia en Línea" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="service-section terapia-pareja" id="duelo">
        <div className="container">
          ...
          <div className="service-content">
            <div className="service-image">
              <img src={DueloImg} alt="Duelo" />
            </div>
            <div className="service-info">
              <p className="service-description">
                Ofrecemos un acompañamiento cálido y humano en procesos de
                pérdida, dirigido a los integrantes de la familia, y personas
                cercanas que han sufrido la pérdida de un ser querido. Brindamos
                atención inmediata para contener el impacto emocional y
                familiar, con un espacio centrado en la comprensión, la empatía
                y el apoyo cercano. La terapia de duelo busca ayudar a transitar
                el dolor, afrontar las problemáticas emocionales derivadas y
                encontrar sentido en medio de la pérdida. Se trabaja con un
                enfoque breve, práctico y sensible, ofreciendo herramientas que
                favorecen la aceptación y el fortalecimiento personal en cada
                etapa del proceso.
              </p>
          ...
          <div className="service-content">
            <div className="service-info">
              <p className="service-description">
                ...
                deportistas y atletas, desde los 6 años. Entrenamos directamente
                el cerebro del atleta como parte de un proceso integral que
                complementa la preparación física y técnica de su deporte. A
                través de ejercicios especializados se fortalecen funciones como
                la atención, la memoria, la velocidad de procesamiento y
                respuesta, la inhibición y la gestión de la información. Este
                entrenamiento no solo optimiza el rendimiento deportivo, sino
                que también repercute positivamente en otras áreas de la vida,
                como el desempeño escolar, la madurez y los desafíos del día a
                día. Además, constituye la base para el control de emociones,
                favoreciendo una actitud deportiva madura, equilibrada y
                adecuada frente a los retos de la competencia y del desarrollo
                personal.
              </p>
              ...
              <div className="therapy-icons">
                {neuropsicologiaIcons.map((iconData, iconIndex) => (
                  <div
                    ...
                    onMouseEnter={() =>
                      setHoveredIcon(`neuropsicologia-${iconIndex}`)
                    }
                    onMouseLeave={() => setHoveredIcon(null)}
                  >
                    <iconData.icon />
      ...
      <section id="VITAE" className="service-section">
        <div className="container">
          ...
          <div className="service-content">
            ...
            <div className="service-info">
              <p className="service-description">
                Espacio de acompañamiento para descubrir y potenciar tus
                intereses, habilidades y metas académicas, brindando
                herramientas que te ayuden a tomar decisiones informadas sobre
                          ...
                          {type.icons &&
                            type.icons.map((iconData, iconIndex) => (
                              <div
                                ...
                                onMouseEnter={() =>
                                  setHoveredIcon(
                                    `Orientación Vocacional-${index}-${iconIndex}`,
                                  )
                                }
                                onMouseLeave={() => setHoveredIcon(null)}
                              >
      ...
      >
        <div className="container">
          ...
          <div className="service-content">
            <div className="service-info">
              <p className="service-description">
                Ofrecemos atención psicológica especializada a personas con
                diversidad como autismo, síndrome de Down, TDAH y retrasos en el
                desarrollo. Nuestro trabajo se centra en brindar herramientas
                prácticas y personalizadas que favorezcan la autonomía, la
                comunicación, la autorregulación y la adaptación a los retos del
                día a día. Además, acompañamos a las familias y cuidadores a
                través de espacios de psicoeducación, donde reciben recursos y
                estrategias que les permiten comprender mejor a sus seres
                queridos y apoyarlos en su desarrollo. Nuestro enfoque integral
                busca potenciar el bienestar, la inclusión y la calidad de vida
      ...
      <section
        id="charlas-talleres"
        className="service-section charlas-talleres-grid-view"
      >
        <div className="container">
          {/* Encabezado igual */}
          <div className="service-header">
          ...
          <div className="service-intro">
            ...
            <div className="service-info">
              <p className="service-description">
                Nuestras conferencias y talleres están diseñados para brindar
                espacios de aprendizaje, reflexión y crecimiento personal.
                Abordamos temas diversos como la independencia familiar, el
                manejo escolar del autismo y neuropsicología deportiva.
              </p>
            </div>
          </div>
      ...
      >
        <div className="container">
          ...
          <div className="service-content reverse">
            <div className="service-info">
              <p className="service-description">
                Ofrecemos un servicio integral de diseño, planificación,
                ejecución y evaluación de proyectos psicosociales e
                institucionales. Desarrollamos talleres, charlas, programas
                preventivos y evaluaciones especializadas según las necesidades
                de cada organización. Nuestro equipo se encarga de todo el
                proceso, asegurando intervenciones efectivas, medibles y
              ...
              <div className="specific-services azul">
                ...
                <ul className="services-list">
                  <li>
                    <strong>Diseño y planificación de proyectos:</strong>{" "}
                    Creamos propuestas de intervención adaptadas a las
                    necesidades de la institución o comunidad: talleres,
                    programas de prevención, campañas educativas, protocolos,
                    capacitaciones, evaluaciones de clima laboral, etc.
                  </li>
                  <li>
                    <strong>Ejecución y facilitación:</strong> Nos encargamos de
                    llevar a cabo las actividades planificadas, como talleres
                    para la comunidad, programas para estudiantes y jornadas de
                    capacitación profesional.
                  </li>
                  <li>
                    <strong>Evaluación y medición:</strong> Aplicamos
                    instrumentos para evaluar personal (burnout, estrés,
                    desempeño), impacto de programas, necesidades de la
                    población y resultados pre/post intervención.
                  </li>
                  <li>
                    <strong>Gestión y coordinación:</strong> Incluye logística,
                    cronogramas, materiales, informes, coordinación con aliados
                    y cierre del proyecto.
                  </li>
                  <li>
                    <strong>Evaluación de proyectos:</strong> Análisis de
                    resultados e impacto a través de instrumentos de medición y
